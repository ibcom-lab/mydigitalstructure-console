/*
	...
	lambda-local -l index.js -t 9000 -e event-console-objects.json
...
exports.handler = function (event, context, callback)
{
	...
	function main(err, data)
	{
		...
		if (namespace != undefined)
		{
			...
			var automatefactory = require('./consolefactory.' + namespace + '.js');
		}
		...
		{
			mydigitalstructure._util.message('!! No controller set [event.controller]');
		}
		else
		{
